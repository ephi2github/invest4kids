...
export default function HeroSection() {
  return (
    <section className="relative bg-bg-light-blue pb-20 pt-16 md:pb-28 md:pt-[190px]">
      <Container>
        <div className="relative flex flex-col-reverse items-center gap-10 md:flex-row md:gap-6">
          {/* Left — Text content */}
          <div className="relative z-10 w-full md:w-[590px]">
            <h1 className="text-[32px] md:text-[34px] font-extrabold leading-tight text-text-medium pb-[24px]">
            ...
            <div className="flex flex-col gap-y-2.5 font-outfit w-full pb-8.5">
              <div className="flex items-center gap-3 w-full">
                <CheckIcon />
                <p className="text-[18px] leading-6 text-[#4B5563]">
            ...
            <div className="flex flex-wrap items-center justify-between font-outfit pb-4">
              <a
                href="https://funnel.perspective.co/60b7c8d2bcad43001f5c35a3/690b34a62100cd003c13e6ad/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center max-h-12.5 gap-1.5 rounded-full bg-primary px-9 py-[15px] text-[18px] font-medium text-white transition-all hover:bg-accent-hover hover:text-text-medium"
              >
              ...
              <Link
                ...
                className="inline-flex items-center max-h-12.5 rounded-full border border-primary/40 bg-white px-9 py-[15px] text-[18px] font-medium text-text-medium"
              >
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-[18px] text-text-muted font-outfit">
