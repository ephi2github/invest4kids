          ...
          <div className="w-full md:w-auto md:pr-24">
            <div className="flex w-full max-w-[468px] flex-col gap-[24px] md:w-[468px]">
              <div className="flex flex-col gap-[16px]">
                <div className="w-fit rounded-[50px] border border-[#F8BF3C] bg-[#FFFAEE] px-[16px] py-[6px]">
                  <p className="font-outfit text-[12px] font-normal leading-none text-[#4B5563]">
                    verständlich, ehrlich, individuell
                  </p>
                </div>

                <h2 className="font-poppins text-[27px] font-extrabold leading-[150%] text-[#2C3E50] md:text-[34px] md:leading-[125%]">
              ...
              <p className="font-outfit text-[16px] font-normal leading-[126%] text-[#4B5563] md:text-[18px] md:leading-[23px]">
                ...
                aufgebaut hast: In einem persönlichen Gespräch schauen wir
                gemeinsam, was für deine Situation sinnvoll ist.
                Verständlich erklärt. Ohne Verkaufsdruck. Aber mit einem
                echten Plan.
              </p>
